...
"""
        ...
        # Use ThreadPoolExecutor to avoid blocking the async loop
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔══════════╗
[FFFFFF]✨ THE REAL OWNER OF BOT   
[FFFFFF]          ⚡  AJGOR BHAI ❤️  
[FFFFFF]                   কিরে কি অবস্থা??
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]CROWN OP    
[FFD700]✨ Name on TELEGRAM : [FFFFFF] @AJGOROP❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> AJGOR OP❄️  ⚡
"""
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To AJGOR ˣ ʙᴏᴛ"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]AJGOR BHAI
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]AJGOR BOT
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = '4416005786','5BF14E78CE2D7C9CB5FFFF3939CDE6949ABE6B68BCC79F8119D1628940A0BE46'
    ...
    os.system('clear')
    print("Initializing CROWN OP Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)

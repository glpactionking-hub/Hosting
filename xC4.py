...
[FF0000]T E A M J O I N E D  S U C C E S S F U L L Y[00FF00]        
Crown Op [FF0000]STYLE [00FF00]TCP BOT
CONTACT TELEGRAM FOR MORE INFORMATION[00FF00]
FF0000]Crown Op THE NAME SIMULATE THE GAME [00FF00]
"""
    fields = {
    1: 5,
    2: {
...
async def xSEndMsg(Msg , Tp , Tp2 , id , K , V):
    feilds = {1: id , 2: Tp2 , 3: Tp, 4: Msg, 5: 1735129800, 7: 2, 9: {1: "Crown Op", 2: int(await xBunnEr()), 3: 901048020, 4: 330, 5: 1001000001, 8: "Crown Op", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 12484827014, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0013\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}, 12: 0}, 10: "en", 13: {3: 1}}
...
async def xSEndMsgsQ(Msg , id , K , V):
    fields = {1: id , 2: id , 4: Msg , 5: 1756580149, 7: 2, 8: 904990072, 9: {1: "Crown Op", 2: await xBunnEr(), 4: 330, 5: 1001000001, 8: "Crown Op", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 1158053040, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0015\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}}, 10: "en", 13: {2: 2, 3: 1}}
